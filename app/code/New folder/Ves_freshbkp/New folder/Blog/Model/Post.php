...
class Post extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function getPostTags()
    {
        ...
        $select = 'SELECT * FROM ' . $this->getResource()->getTable('ves_blog_post_tag') . ' WHERE post_id = "' . $this->getData("post_id") . '"';
    ...
    public function getPostCategories(){
        $connection = $this->getResource()->getConnection();
        $select = 'SELECT * FROM ' . $this->getResource()->getTable('ves_blog_post_category');
        $categories = $connection->fetchAll($select);
        $tmp = [];
        foreach ($categories as $k => $v) {
            if($v['post_id'] == $this->getData("post_id")){
                $select = 'SELECT * FROM ' . $this->getResource()->getTable('ves_blog_category') . ' WHERE category_id = ' . $v['category_id'];
                $select = $connection->select()->from(['ves_blog_category' => $this->getResource()->getTable('ves_blog_category')])
